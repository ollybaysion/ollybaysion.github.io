...
import { COORDS_VERSION, D_MAX, NEIGHBOR_LIMIT } from '../src/lib/coords/constants.ts';
import { constellations, groupByCategory, neighborMap } from '../src/lib/coords/derive.ts';
import { toPoint } from '../src/lib/coords/position.ts';
import { GENERATED_DIR, PROJECT_ROOT, readLedger, readPosts, writeJson } from './lib/content.mjs';
...
console.log(
	`[derived] ${placed.length}편 · 카테고리 ${Object.keys(categories).length}종 · 시리즈 ${seriesCount}개 → ` +
		`${path.relative(PROJECT_ROOT, GENERATED_DIR)}/`,
);
